...
/**
 * Устройство для рисования: Графичекий принтер 
 * @author Igor Morenko (emailto:imorenko@yandex.ru)
 */
public class GraphicPrinter implements DrawDevice {

    public GraphicPrinter() {
        System.out.println("Initialize Graphics Printer...");
    }
    
    private Color color;

    private void print(String shape, Object... args) {
        System.out.print("Draw on Papper: " + shape + " (");
